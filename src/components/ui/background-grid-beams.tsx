      ...
      <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
        <defs>
          ...
          <linearGradient id="beam2" x1="100%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="hsl(210 40% 60%)" stopOpacity="0" />
            <stop offset="50%" stopColor="hsl(210 40% 60%)" stopOpacity="0.08" />
            <stop offset="100%" stopColor="hsl(210 40% 60%)" stopOpacity="0" />
          </linearGradient>
        </defs>
